...
import com.dianping.cat.alarm.spi.sender.DingTalkSender;
...
import com.dianping.cat.alarm.spi.spliter.DintTalkSpliter;
...
public class ComponentsConfigurator extends AbstractResourceConfigurator {
  ...
  public List<Component> defineComponents() {
    ...
    all.add(C(Spliter.class, DintTalkSpliter.ID, DintTalkSpliter.class));
